...
class VisualControl:
    ...
    def run(cls, target_marker, drone_status,compteur, obstacles):# partie à modifier
        ...
        rb_threshold = subsys_environment.Environment.Pourcentage_vitesse# pourcentage de vitesse fixé dans l'environnement
        if rc_status.d<15:
        ...
        if type=="b" and drone_status.hauteur>hauteur_obs:
            print("MONTER",drone_status.hauteur)
            rc_status.c=-15
        return rc_status
